...
wordmapfile  = '/Users/dehao/github/Lydata/ckip/model/wordmap.txt'
#trnfile = "/Users/dehao/github/Lydata/ckip/model/test.dat"
trnfile = "/Users/dehao/github/Lydata/issckip/C1parse/C2/"
modelfile_suffix = "/Users/dehao/github/Lydata/Report/Model/C1_2/C1final"
...
class Model(object):
    ...
    def save_model(self):
        with open(self.modelfile_suffix+'theta.csv', 'w') as ftheta:
            ftheta.write('Cluster0,Cluster1\n')
            for x in xrange(self.dset.M):
                for y in xrange(self.K):
        ...
        with open(self.modelfile_suffix+'.phi', 'w') as fphi:
            for x in xrange(self.K):
                ...
                fphi.write('\n')
        with open(self.modelfile_suffix+'.topwords','w') as ftwords:
...
def readtrnfile():
    ...
    docs = []
    docname = []
    for f in listdir(trnfile):
        docname.append(f)
        parse = []
        fi = codecs.open(trnfile+f, 'r', encoding='utf-8')
        for line in fi:
    ...
    with open(modelfile_suffix+'docname.txt', 'w') as fdocname:
        for doc in docname:
            fdocname.write(doc)
            fdocname.write('\n')
            pass
